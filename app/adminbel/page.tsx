...
export default function AdminPage() {
  ...
  if (!user) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-background">
        <Card className="w-full max-w-lg bg-card border shadow-lg rounded-lg overflow-hidden">
          <CardHeader className="text-center pb-6 pt-12 px-8">
            <div className="h-24 w-24 rounded-lg bg-muted flex items-center justify-center mx-auto mb-6 border">
              <Image src="/logo.png" alt="Белавто Центр" width={70} height={70} className="object-contain" />
            </div>
            <CardTitle className="text-foreground text-2xl font-semibold mb-3">
              Панель администратора
            </CardTitle>
            <p className="text-muted-foreground text-sm">Белавто Центр</p>
          </CardHeader>
          ...
          <CardContent className="px-8 pb-10">
            <form onSubmit={handleLogin} className="space-y-5">
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    className="bg-background border text-foreground rounded-md h-11 px-4 focus:border-primary focus:ring-1 focus:ring-ring"
                    required
                  />
                </div>
              </div>
              ...
              {loginError && (
                <div className="bg-destructive/10 border border-destructive/20 text-destructive text-sm font-medium py-3 px-4 rounded-md">
              ...
              <Button
                type="submit"
                className="w-full h-11 bg-primary hover:bg-primary/90 text-primary-foreground font-medium rounded-md mt-6"
  ...
  return (
    <div className="min-h-screen bg-background">
      <Toaster />
      {/* Шапка админки */}
      <header className="bg-muted/50 border-b shadow-sm">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div className="min-w-0">
                <h1 className="text-lg md:text-xl font-bold text-foreground truncate">Админ-панель</h1>
                <p className="text-xs md:text-sm text-muted-foreground truncate">Белавто Центр</p>
              </div>
            </div>
            <div className="flex items-center space-x-2 md:space-x-4">
              ...
              <Button
                ...
                variant="outline"
                size="sm"
                className="text-destructive hover:bg-destructive/10 bg-card flex-shrink-0"
              ...
              <Button
                ...
                variant="outline"
                size="sm"
                className="text-foreground hover:bg-muted bg-card flex-shrink-0"
              >
        ...
        <Tabs defaultValue="settings" className="w-full">
          ...
          <div className="md:hidden">
            <div className="overflow-x-auto pb-4">
              <TabsList className="flex w-max min-w-full space-x-2 bg-muted h-auto p-2">
                <TabsTrigger
                  value="settings"
                  className="flex flex-col items-center justify-center min-w-[80px] h-16 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground text-muted-foreground text-xs px-2"
                >
          ...
          <div className="hidden md:block">
            <TabsList className="grid w-full grid-cols-4 lg:grid-cols-12 bg-muted">
              <TabsTrigger
                value="settings"
                className="flex items-center space-x-2 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground text-muted-foreground"
              >
