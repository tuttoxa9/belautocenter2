...
interface CreditClientProps {
    initialSettings: CreditPageSettings | null;
}

export default function CreditClient({ initialSettings }: CreditClientProps) {
  const [settings, setSettings] = useState<CreditPageSettings | null>(initialSettings)
