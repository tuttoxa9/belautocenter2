        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              <section className="relative pt-8 pb-24 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-700 text-white rounded-t-[30px] -mb-16 overflow-hidden -mx-4 sm:-mx-6 lg:-mx-[calc((100vw-1280px)/2+24px)]">
