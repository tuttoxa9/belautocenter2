...
interface LeasingClientProps {
    initialSettings: LeasingPageSettings | null;
}

export default function LeasingClient({ initialSettings }: LeasingClientProps) {
  const [settings, setSettings] = useState<LeasingPageSettings | null>(initialSettings)
