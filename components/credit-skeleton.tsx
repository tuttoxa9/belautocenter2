            ...
            <div className="lg:col-span-2">
              <div className="bg-white/70 backdrop-blur-xl rounded-2xl md:rounded-3xl p-3 md:p-6 h-full shadow-lg shadow-gray-900/5 border-0">
                ...
                <div className="space-y-3 md:space-y-3">
                  ...
                  <div>
                    <div className="h-3 bg-gray-200/60 rounded w-24 mb-1 animate-pulse"></div>
                    <div className="h-10 bg-gray-200/60 rounded-xl animate-pulse"></div>
                  </div>
          ...
          <div className="p-4 md:p-8">
            ...
            <div className="flex gap-3 md:gap-4 overflow-hidden pb-4">
              {Array.from({ length: 5 }).map((_, index) => (
                <div key={index} className="min-w-[240px] md:min-w-[280px] max-w-[240px] md:max-w-[280px] bg-white/80 rounded-lg md:rounded-xl border border-gray-200/40 overflow-hidden">
